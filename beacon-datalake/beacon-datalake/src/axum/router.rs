...
fn web_ui_router(dir: &str) -> Option<Router<Arc<DataLake>>> {
...
fn set_api_docs_info(
    ...
    cfg: &beacon_datalake_config::ApiDocsConfig,
...
fn build_cors_layer(cors: &beacon_datalake_config::CorsConfig) -> anyhow::Result<CorsLayer> {
