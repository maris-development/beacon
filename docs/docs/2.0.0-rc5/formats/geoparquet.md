...
[`read_geoparquet()`](/docs/2.0.0-rc5/sql/table-functions#read-geoparquet) table function:
...
Use the [spatial functions](/docs/2.0.0-rc5/sql/spatial-functions). Those
...
geometry column on output. See [output formats](/docs/2.0.0-rc5/api/querying/).
:::
...
[GeoParquet in Supported Formats](/docs/2.0.0-rc5/server/datasets#supported-formats) for the
details.
