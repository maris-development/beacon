...
[Configuration](/docs/2.0.0-rc5/server/configuration#file-statistics) lists each variable.
...
- [Configuration](/docs/2.0.0-rc5/server/configuration#file-statistics) lists each variable.
- [Storage internals](/docs/2.0.0-rc5/internals/storage) shows the other content of `beacon.db`.
- [Performance tuning](/docs/2.0.0-rc5/server/performance-tuning) shows the other controls.
