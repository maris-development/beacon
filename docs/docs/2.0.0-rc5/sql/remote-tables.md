...
[Remote Tables (Federation) setup chapter](/docs/2.0.0-rc5/data-sources/remote-tables)
...
[limitations in the setup chapter](/docs/2.0.0-rc5/data-sources/remote-tables#limitations).
:::
