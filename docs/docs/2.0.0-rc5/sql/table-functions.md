...
[external table](/docs/2.0.0-rc5/data-sources/external-tables) first. Use a table function
...
Beacon reads a [Delta Lake](/docs/2.0.0-rc5/formats/delta-lake) table. The
...
Use [`CREATE EXTERNAL TABLE … STORED AS DELTA`](/docs/2.0.0-rc5/formats/delta-lake)
...
Beacon reads an [Apache Iceberg](/docs/2.0.0-rc5/formats/iceberg) table. The `location`
...
Use [`CREATE EXTERNAL TABLE … STORED AS ICEBERG`](/docs/2.0.0-rc5/formats/iceberg)
...
Beacon reads an [Icechunk](/docs/2.0.0-rc5/formats/icechunk) repository as a Zarr store. A
...
[`CREATE EXTERNAL TABLE … STORED AS ICECHUNK`](/docs/2.0.0-rc5/formats/icechunk) adds a repository
