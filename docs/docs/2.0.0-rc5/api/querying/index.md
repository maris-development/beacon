...
| ----- | ----------- | -------- |
| [JSON DSL](/docs/2.0.0-rc5/api/querying/json) | A client program or a query builder | `select`, `from`, `filters`, … |
| [SQL](/docs/2.0.0-rc5/api/querying/sql) | An expert user or an ad-hoc analysis | `sql` |
...
[JSON DSL `from` reference](/docs/2.0.0-rc5/api/querying/json#choosing-the-data-source-from) and the
[SQL table functions](/docs/2.0.0-rc5/api/querying/sql#query-files-directly).
