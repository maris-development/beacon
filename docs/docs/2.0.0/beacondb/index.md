...
[Beacon Data Lake](/docs/2.0.0/getting-started).

## How this chapter is organized

1. **[How It Works](/docs/2.0.0/beacondb/how-it-works)**: the engine, the query pipeline, and the
   storage model.
2. **[Data Sources](/docs/2.0.0/beacondb/data-sources/)**: reading external files and object storage,
   connecting to other databases, and BeaconDB's own internal format.
3. **[SQL Reference](/docs/2.0.0/beacondb/sql/)**: statements, functions, and syntax.
4. **[Python Binding](/docs/2.0.0/beacondb/python/)**: the client API, from `connect()` to dataframes.
5. **[Guides](/docs/2.0.0/beacondb/guides/)**: task-oriented walkthroughs.
