...
Store credentials once as a named [secret](/docs/2.0.0/beacondb/sql/secrets) rather than putting keys
...
- **Prefer cloud-optimized formats.** Parquet,
  [Zarr](/docs/2.0.0/beacondb/data-sources/formats/zarr),
  [Atlas](/docs/2.0.0/beacondb/data-sources/formats/atlas), and Cloud-Optimized GeoTIFF are built for
...
- **Mind NetCDF.** Over object storage, NetCDF currently supports anonymous access only. See
  [NetCDF](/docs/2.0.0/beacondb/data-sources/formats/netcdf).
