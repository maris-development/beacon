...
ODV is one of the two formats (with [Delta Lake](/docs/2.0.0/beacondb/data-sources/formats/delta-lake)) that is **not**
...
See [Reading External Files](/docs/2.0.0/beacondb/data-sources/) for the general reading model.
