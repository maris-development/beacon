...
[object storage](/docs/2.0.0/beacondb/sql/secrets) (`s3://`, `gs://`, `az://`).

## Formats

| Format | Function | `STORED AS` | Recognized files |
| --- | --- | --- | --- |
| [Parquet](/docs/2.0.0/beacondb/data-sources/formats/parquet) | `read_parquet` | `PARQUET` | `.parquet` |
| [GeoParquet](/docs/2.0.0/beacondb/data-sources/formats/geoparquet) | `read_geoparquet` | `GEOPARQUET` | `.geoparquet` |
| [CSV / TSV](/docs/2.0.0/beacondb/data-sources/formats/csv) | `read_csv` | `CSV` | `.csv`, `.tsv` |
| [Arrow IPC](/docs/2.0.0/beacondb/data-sources/formats/arrow) | `read_arrow` | `ARROW` | `.arrow`, `.feather` |
| [NetCDF](/docs/2.0.0/beacondb/data-sources/formats/netcdf) | `read_netcdf` | `NC` | `.nc` |
| [Zarr](/docs/2.0.0/beacondb/data-sources/formats/zarr) | `read_zarr` | `ZARR` | `zarr.json` marker |
| [Atlas](/docs/2.0.0/beacondb/data-sources/formats/atlas) | `read_atlas` | `ATLAS` | `atlas.json` marker |
| [GeoTIFF / COG](/docs/2.0.0/beacondb/data-sources/formats/geotiff) | `read_tiff` | `TIFF` | `.tif`, `.tiff` |
| [BBF](/docs/2.0.0/beacondb/data-sources/formats/bbf) | `read_bbf` | `BBF` | `.bbf` |
| [Delta Lake](/docs/2.0.0/beacondb/data-sources/formats/delta-lake) | `read_delta` | `DELTA` | `_delta_log/` directory |
| [ODV ASCII](/docs/2.0.0/beacondb/data-sources/formats/odv) | `read_odv_ascii` | not supported | `.txt` |
...
[`read_schema()`](/docs/2.0.0/beacondb/sql/table-functions-utility#read_schema) does this **without
reading any data**:
...
[`SUMMARIZE`](/docs/2.0.0/beacondb/sql/summarize) profiles every column in a single pass:
...
Array formats such as [Zarr](/docs/2.0.0/beacondb/data-sources/formats/zarr) and [Atlas](/docs/2.0.0/beacondb/data-sources/formats/atlas) point at their marker file (`zarr.json`,
...
once as an [external table](/docs/2.0.0/beacondb/data-sources/external-tables) and query it by name:
...
- [Table Functions](/docs/2.0.0/beacondb/sql/table-functions): every reader signature in one place.
- [Reading External Files](/docs/2.0.0/beacondb/data-sources/): the reading model end to end.
- [Secrets](/docs/2.0.0/beacondb/sql/secrets): credentials for S3, GCS, and Azure.
