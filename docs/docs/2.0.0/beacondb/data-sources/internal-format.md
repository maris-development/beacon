...
[Managed Tables](/docs/2.0.0/beacondb/sql/managed-tables) in the SQL reference for the full
...
[materialized view](/docs/2.0.0/beacondb/sql/create-materialized-view) is usually the better fit.

## Secrets

Credentials for object stores and remote Beacons are stored as named, scoped
[secrets](/docs/2.0.0/beacondb/sql/secrets). A session secret lives in memory; a
