...
`fetch`. It runs SQL or the [JSON query DSL](/docs/2.0.0/api/querying/json),
...
`GET /api/admin/check`. See the [REST API reference](/docs/2.0.0/api/) for the
...
call the server directly. The bundled [Admin Web UI](/docs/2.0.0/connect/web-admin-ui)
