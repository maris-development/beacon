...
New here? Jump to the **[Quick Start](/docs/2.0.0/quickstart)** to get running in a couple of minutes.
...
[Get started with BeaconDB &rarr;](/docs/2.0.0/beacondb/python/getting-started)
...
[Get started with Beacon Data Lake &rarr;](/docs/2.0.0/getting-started)

## One engine, one SQL

Whichever you choose, the SQL dialect, the supported formats, and the query semantics are the same.
Everything in the [SQL reference](/docs/2.0.0/beacondb/sql/) works either way. A query travels
...
[`ATTACH`](/docs/2.0.0/beacondb/python/remote-catalogs) a running **Beacon Data Lake** and query it,
joining remote tables against local files. See [Concepts](/docs/2.0.0/concepts) for how the engine,
