...
[external tables](/docs/2.0.0-rc4/data-sources/external-tables). You therefore write no
...
one table, a plain [`CREATE EXTERNAL TABLE`](/docs/2.0.0-rc4/sql/create-external-table) is simpler.
:::
...
[`read_zarr`](/docs/2.0.0-rc4/sql/table-functions#read-zarr). A crawl ignores these stores
...
[`CREATE EXTERNAL TABLE ... STORED AS DELTA`](/docs/2.0.0-rc4/formats/delta-lake).

## See also

- [External Tables](/docs/2.0.0-rc4/data-sources/external-tables): the tables that a crawler produces
- [`CREATE EXTERNAL TABLE`](/docs/2.0.0-rc4/sql/create-external-table): the manual form, with `PARTITIONED BY`
- [Configuration](/docs/2.0.0-rc4/server/configuration): every Beacon setting
