...
behind a real archive. Continue to **[Getting Started](/docs/2.0.0-rc4/getting-started)** for Docker
...
There are clients for [TypeScript](/docs/2.0.0-rc4/connect/typescript), the
[terminal](/docs/2.0.0-rc4/connect/cli), and any JDBC or ADBC tool over
[Arrow Flight SQL](/docs/2.0.0-rc4/connect/datagrip).
...
the connection. See [ATTACH](/docs/2.0.0-rc4/data-sources/attach) for authentication. See
[Remote Tables](/docs/2.0.0-rc4/sql/remote-tables) to attach one table instead of a whole
catalog.
...
| | |
|---|---|
| **Run it properly** | [Getting Started](/docs/2.0.0-rc4/getting-started) · [Configuration](/docs/2.0.0-rc4/server/configuration) |
| **Name your data** | [Server Setup](/docs/2.0.0-rc4/server/) |
| **Write queries** | [SQL Reference](/docs/2.0.0-rc4/sql/) |
| **Coming from Python** | [Coming from xarray](/docs/2.0.0-rc4/coming-from-xarray) |
