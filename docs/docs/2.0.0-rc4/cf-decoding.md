...
[Attribute columns](/docs/2.0.0-rc4/arrays-to-tables#attribute-columns).
...
- [NetCDF](/docs/2.0.0-rc4/formats/netcdf) for format-specific behaviour
- [Troubleshooting](/docs/2.0.0-rc4/troubleshooting) for the errors these attributes cause
