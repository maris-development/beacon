...
[views](/docs/2.0.0-rc4/sql/create-view) and table functions such as `read_netcdf()`,
`read_zarr()` and `read_atlas()`.

A regular [view](/docs/2.0.0-rc4/sql/create-view) runs its query on every reference. A
