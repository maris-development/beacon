...
[external table](/docs/2.0.0-rc4/data-sources/external-tables) first. Use a table function
...
Beacon reads the [Atlas](/docs/2.0.0-rc4/formats/atlas) array stores that match
...
Beacon reads a [Delta Lake](/docs/2.0.0-rc4/formats/delta-lake) table. The
...
Use [`CREATE EXTERNAL TABLE … STORED AS DELTA`](/docs/2.0.0-rc4/formats/delta-lake)
...
Beacon reads an [Apache Iceberg](/docs/2.0.0-rc4/formats/iceberg) table. The `location`
...
Use [`CREATE EXTERNAL TABLE … STORED AS ICEBERG`](/docs/2.0.0-rc4/formats/iceberg)
...
Beacon reads an [Icechunk](/docs/2.0.0-rc4/formats/icechunk) repository as a Zarr store. A
...
[`CREATE EXTERNAL TABLE … STORED AS ICECHUNK`](/docs/2.0.0-rc4/formats/icechunk) adds a repository
