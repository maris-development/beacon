...
[Atlas](/docs/2.0.0-rc4/formats/atlas) collection. Atlas merges many NetCDF
...
See [`OPTIONS`](/docs/2.0.0-rc4/sql/create-external-table#options) for the rules that hold for every key. See
[Arrays to tables](/docs/2.0.0-rc4/arrays-to-tables#the-dimensions-argument) for the grid rule.
