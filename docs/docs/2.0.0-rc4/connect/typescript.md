...
It runs SQL and the [JSON query DSL](/docs/2.0.0-rc4/api/querying/json). It
...
`GET /api/admin/check`. The [REST API reference](/docs/2.0.0-rc4/api/) lists every
admin endpoint.
...
[admin path alias](/docs/2.0.0-rc4/api/#admin-path-alias) for the rules.
...
[Admin Web UI](/docs/2.0.0-rc4/connect/web-admin-ui) uses this SDK only. It is a
good example.
