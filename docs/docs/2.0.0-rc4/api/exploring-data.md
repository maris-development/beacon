...
can read. See [Access control](/docs/2.0.0-rc4/security/access-control).
...
The [table function reference](/docs/2.0.0-rc4/sql/table-functions) holds every table
function and its signature. The
[Function Reference](/docs/2.0.0-rc4/sql/function-reference) holds the other functions.
...
Create a crawler. This endpoint matches [`CREATE CRAWLER`](/docs/2.0.0-rc4/server/crawlers):
