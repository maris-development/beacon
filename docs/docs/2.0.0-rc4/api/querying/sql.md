...
`read_tiff`. See [Read Files](/docs/2.0.0-rc4/sql/table-functions) for the full
signatures.

## Output formats

See [Querying, Output formats](/docs/2.0.0-rc4/api/querying/#output-formats) for the full list. Put
