...
can read. See [Access control](/docs/2.0.0-rc6/security/access-control).
...
The [table function reference](/docs/2.0.0-rc6/sql/table-functions) holds every table
...
Create a crawler. This endpoint matches [`CREATE CRAWLER`](/docs/2.0.0-rc6/server/crawlers):
