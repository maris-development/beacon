...
functions](/docs/2.0.0-rc6/sql/spatial-functions) of the SQL path. A JSON filter and a SQL `WHERE`
...
See [Querying, Output formats](/docs/2.0.0-rc6/api/querying/#output-formats) for the full list. The
