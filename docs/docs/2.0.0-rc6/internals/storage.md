...
Use an [external table](/docs/2.0.0-rc6/data-sources/external-tables) to query data that you already
...
[Managed Tables](/docs/2.0.0-rc6/sql/managed-tables) in the SQL reference. It gives the full
...
[secrets](/docs/2.0.0-rc6/sql/secrets). A session secret lives in memory. A
