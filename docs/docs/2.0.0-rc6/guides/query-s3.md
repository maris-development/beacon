...
See [Object Storage](/docs/2.0.0-rc6/data-sources/object-storage) for every setting, and
[Configuration](/docs/2.0.0-rc6/server/configuration) for the full list.
...
reach with [`ATTACH`](/docs/2.0.0-rc6/data-sources/attach). Storage credentials come from the
...
- **Watch NetCDF.** On object storage, NetCDF supports anonymous access only. See
  [NetCDF](/docs/2.0.0-rc6/formats/netcdf).
...
See [External Tables](/docs/2.0.0-rc6/data-sources/external-tables).
