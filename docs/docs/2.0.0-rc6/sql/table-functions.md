...
[external table](/docs/2.0.0-rc6/data-sources/external-tables) first. Use a table function
...
Beacon reads the [Atlas](/docs/2.0.0-rc6/formats/atlas) collections that match one or more glob
...
Beacon reads a [Delta Lake](/docs/2.0.0-rc6/formats/delta-lake) table. The
...
Use [`CREATE EXTERNAL TABLE … STORED AS DELTA`](/docs/2.0.0-rc6/formats/delta-lake)
...
Beacon reads an [Apache Iceberg](/docs/2.0.0-rc6/formats/iceberg) table. The `location`
...
Use [`CREATE EXTERNAL TABLE … STORED AS ICEBERG`](/docs/2.0.0-rc6/formats/iceberg)
...
Beacon reads an [Icechunk](/docs/2.0.0-rc6/formats/icechunk) repository as a Zarr store. A
...
[`CREATE EXTERNAL TABLE … STORED AS ICECHUNK`](/docs/2.0.0-rc6/formats/icechunk) adds a repository
