...
[NetCDF](/docs/2.0.0-rc6/formats/netcdf) and [Zarr](/docs/2.0.0-rc6/formats/zarr) — see
[CF decoding](/docs/2.0.0-rc6/cf-decoding).
...
[materialized view](/docs/2.0.0-rc6/sql/create-materialized-view). This works over an Atlas
...
See [Create External Tables](/docs/2.0.0-rc6/data-sources/external-tables) for the full DDL. See
[Data Sources](/docs/2.0.0-rc6/data-sources/) for the full read model.
...
See [`OPTIONS`](/docs/2.0.0-rc6/sql/create-external-table#options) for the rules that hold for every
key. See [Arrays to tables](/docs/2.0.0-rc6/arrays-to-tables#the-dimensions-argument) for the grid
rule.
