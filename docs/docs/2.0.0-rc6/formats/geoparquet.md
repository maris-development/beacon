...
[`read_geoparquet()`](/docs/2.0.0-rc6/sql/table-functions#read-geoparquet) table function:
...
Use the [spatial functions](/docs/2.0.0-rc6/sql/spatial-functions). Those
...
geometry column on output. See [output formats](/docs/2.0.0-rc6/api/querying/).
:::
...
[GeoParquet in Supported Formats](/docs/2.0.0-rc6/server/datasets#supported-formats) for the
details.
...
[`OPTIONS`](/docs/2.0.0-rc6/sql/create-external-table#options) for the formats that do read one.
