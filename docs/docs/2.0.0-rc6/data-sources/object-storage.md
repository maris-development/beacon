...
The same holds for [external tables](/docs/2.0.0-rc6/data-sources/external-tables):
...
See [Configuration](/docs/2.0.0-rc6/server/configuration#s3-object-storage) for every option. It
...
[ATTACH](/docs/2.0.0-rc6/data-sources/attach) and
[Remote Tables](/docs/2.0.0-rc6/sql/remote-tables).

## Performance notes

- **Cloud-optimized formats are faster.** Parquet,
  [Zarr](/docs/2.0.0-rc6/formats/zarr),
  [Atlas](/docs/2.0.0-rc6/formats/atlas) and Cloud-Optimized GeoTIFF support
...
- **NetCDF and HDF5 need an anonymous bucket on the netCDF-c reader.** netCDF-c opens a file by URL
  ...
  [NetCDF](/docs/2.0.0-rc6/formats/netcdf) and [HDF5](/docs/2.0.0-rc6/formats/hdf5).
- **A large bucket is slow to list.** Register a [crawler](/docs/2.0.0-rc6/server/crawlers). It
