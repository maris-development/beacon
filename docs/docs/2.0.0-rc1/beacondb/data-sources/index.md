...
instead, it has [its own internal format](/docs/2.0.0-rc1/beacondb/data-sources/internal-format).

| Source | Read with | Chapter |
| --- | --- | --- |
| Files on local disk | `read_*()` functions or external tables | [File Formats](/docs/2.0.0-rc1/beacondb/data-sources/formats/) |
| Object storage (S3, GCS, Azure) | the same, with an `s3://` style path | [Object Storage](/docs/2.0.0-rc1/beacondb/data-sources/object-storage) |
| A named, reusable set of files | `CREATE EXTERNAL TABLE` | [External Tables](/docs/2.0.0-rc1/beacondb/data-sources/external-tables) |
| Postgres, MySQL, ODBC | federated external tables | [SQL Databases](/docs/2.0.0-rc1/beacondb/data-sources/sql-databases) |
| A single table on another Beacon | `STORED AS REMOTE` | [Remote Tables](/docs/2.0.0-rc1/beacondb/data-sources/remote-tables) |
| An entire remote Beacon catalog | `ATTACH` | [ATTACH](/docs/2.0.0-rc1/beacondb/data-sources/attach) |
| Data BeaconDB owns and can mutate | managed tables in `beacon.db` | [Internal Format](/docs/2.0.0-rc1/beacondb/data-sources/internal-format) |
...
[Zarr](/docs/2.0.0-rc1/beacondb/data-sources/formats/zarr) and
[Atlas](/docs/2.0.0-rc1/beacondb/data-sources/formats/atlas) point at their marker file (`zarr.json`,
...
[File Formats](/docs/2.0.0-rc1/beacondb/data-sources/formats/) for the full list, or the
[table functions reference](/docs/2.0.0-rc1/beacondb/sql/table-functions) for every signature in one
place.
...
- An **[external table](/docs/2.0.0-rc1/beacondb/data-sources/external-tables)** registers a stable,
...
- **Object storage**, for example `s3://my-bucket/obs/*.parquet`. See
  [Object Storage](/docs/2.0.0-rc1/beacondb/data-sources/object-storage).

Access keys for object stores and remote Beacons are stored as named, scoped
[secrets](/docs/2.0.0-rc1/beacondb/sql/secrets) rather than scattered environment variables, and can be
