...
Pass `auth=True` to switch on Beacon's [RBAC](/docs/2.0.0-rc1/security/access-control). A session is then
...
- [Querying](/docs/2.0.0-rc1/beacondb/python/querying), the lazy relation, readers, and file sinks.
- [Bringing data in](/docs/2.0.0-rc1/beacondb/python/data-in)-`register()` / `append()`.
- The full [SQL reference](/docs/2.0.0-rc1/beacondb/sql/) applies unchanged.
