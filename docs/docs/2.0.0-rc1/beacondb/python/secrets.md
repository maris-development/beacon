...
`SECRET`, instead of environment variables. This is the shared [`CREATE SECRET`](/docs/2.0.0-rc1/beacondb/sql/secrets)
...
A `TYPE BEACON` secret stores the credentials for [`ATTACH`](/docs/2.0.0-rc1/beacondb/python/remote-catalogs):
