...
[Beacon Data Lake](/docs/2.0.0-rc1/getting-started).

## How this chapter is organized

1. **[How It Works](/docs/2.0.0-rc1/beacondb/how-it-works)**: the engine, the query pipeline, and the
   storage model.
2. **[Data Sources](/docs/2.0.0-rc1/beacondb/data-sources/)**: reading external files and object storage,
   connecting to other databases, and BeaconDB's own internal format.
3. **[SQL Reference](/docs/2.0.0-rc1/beacondb/sql/)**: statements, functions, and syntax.
4. **[Python Binding](/docs/2.0.0-rc1/beacondb/python/)**: the client API, from `connect()` to dataframes.
5. **[Guides](/docs/2.0.0-rc1/beacondb/guides/)**: task-oriented walkthroughs.
...
| Binding | Status | Docs |
|---|---|---|
| **Python** (`pip install beacondb`) | Available | [Python binding](/docs/2.0.0-rc1/beacondb/python/) |
| **Rust** | Planned | |
...
**[Get started with the Python binding](/docs/2.0.0-rc1/beacondb/python/getting-started)**
