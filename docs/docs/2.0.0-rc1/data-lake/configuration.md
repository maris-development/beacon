...
optional OIDC. See the [Access Control guide](/docs/2.0.0-rc1/security/access-control)
...
`password` of external [SQL database tables](/docs/2.0.0-rc1/beacondb/data-sources/sql-databases). It is required
...
Python ADBC driver (see [Connect](/docs/2.0.0-rc1/connect/jetbrains-datagrip)). Unlike the
...
The [crawler](/docs/2.0.0-rc1/data-lake/crawlers) discovers files under a prefix and registers them as
external tables.
...
Per-format tuning. See [Performance Tuning](/docs/2.0.0-rc1/data-lake/performance-tuning) for guidance
