...
Beacon exclusively through the [`@beacon/client`](/docs/2.0.0-rc1/connect/beacon-typescript-sdk)
TypeScript SDK.
...
- **Tables**: browse registered tables, their Arrow schemas and table
  configuration, register an [external table](/docs/2.0.0-rc1/beacondb/data-sources/external-tables)
...
- **Crawlers**: list, [create, run, and delete crawlers](/docs/2.0.0-rc1/data-lake/crawlers).
- **Users & roles**: manage [role-based access control](/docs/2.0.0-rc1/security/access-control):
