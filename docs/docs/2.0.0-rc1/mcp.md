...
A table becomes an MCP tool when its `mcp` [extension](/docs/2.0.0-rc1/data-lake/extensions)
...
resolution as the [client API](/docs/2.0.0-rc1/security/access-control)):
