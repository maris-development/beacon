...
| ----- | ----------- | -------- |
| [JSON DSL](/docs/2.0.0-rc1/api/querying/json) | Programmatic clients, query builders | `select`, `from`, `filters`, … |
| [SQL](/docs/2.0.0-rc1/api/querying/sql) | Power users, ad-hoc analysis | `sql` |
...
Both styles also support querying files directly without a registered table, see the [JSON DSL `from` reference](/docs/2.0.0-rc1/api/querying/json#choosing-the-data-source-from) and the [SQL table functions](/docs/2.0.0-rc1/api/querying/sql#query-files-directly).
