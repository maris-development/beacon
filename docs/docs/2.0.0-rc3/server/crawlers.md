...
[external tables](/docs/2.0.0-rc3/data-sources/external-tables). You therefore write no
...
[`read_zarr`](/docs/2.0.0-rc3/sql/table-functions#read-zarr). A crawl ignores these stores
...
[`CREATE EXTERNAL TABLE ... STORED AS DELTA`](/docs/2.0.0-rc3/formats/delta-lake).
