...
- Are the listings slow? Then use a [crawler](/docs/2.0.0-rc3/server/crawlers). It keeps the
...
[File statistics](/docs/2.0.0-rc3/internals/file-statistics).
...
[Atlas](/docs/2.0.0-rc3/formats/atlas) collection. Atlas adds dataset pruning
with statistics, next to the chunk pruning. It drops whole datasets before it reads a chunk.
:::

## Atlas Tuning

Beacon opens an [Atlas](/docs/2.0.0-rc3/formats/atlas) store through its
