...
2. **[Beacon-specific functions](#beacon-specific-functions)**: Beacon adds these
   ...
   full list.
3. **[Spatial functions](/docs/2.0.0-rc3/sql/spatial-functions)**: 123 functions
...
and 2 window functions. The [spatial functions chapter](/docs/2.0.0-rc3/sql/spatial-functions)
...
| ----- | --------- | -------- |
| [Accessors](/docs/2.0.0-rc3/sql/spatial-functions#accessors) | 16 | `ST_X`, `ST_Y`, `ST_SRID`, `ST_GeometryType` |
| [Components](/docs/2.0.0-rc3/sql/spatial-functions#components) | 6 | `ST_StartPoint`, `ST_PointN`, `ST_GeometryN` |
| [Constructors](/docs/2.0.0-rc3/sql/spatial-functions#constructors) | 7 | `ST_Point`, `ST_MakeLine`, `ST_MakeEnvelope` |
| [Input and output](/docs/2.0.0-rc3/sql/spatial-functions#input-and-output) | 10 | `ST_AsText`, `ST_AsGeoJSON`, `ST_GeomFromText` |
| [Predicates](/docs/2.0.0-rc3/sql/spatial-functions#predicates) | 15 | `ST_Intersects`, `ST_Within`, `ST_DWithin` |
| [Measurement](/docs/2.0.0-rc3/sql/spatial-functions#measurement) | 9 | `ST_Area`, `ST_Length`, `ST_Distance` |
| [Linear reference](/docs/2.0.0-rc3/sql/spatial-functions#linear-reference) | 4 | `ST_ClosestPoint`, `ST_LineLocatePoint` |
| [Overlay](/docs/2.0.0-rc3/sql/spatial-functions#overlay) | 4 | `ST_Union`, `ST_Intersection`, `ST_Difference` |
| [Processing](/docs/2.0.0-rc3/sql/spatial-functions#processing) | 18 | `ST_Buffer`, `ST_Centroid`, `ST_Simplify` |
| [Validity](/docs/2.0.0-rc3/sql/spatial-functions#validity) | 3 | `ST_IsValid`, `ST_MakeValid` |
| [Affine](/docs/2.0.0-rc3/sql/spatial-functions#affine) | 4 | `ST_Translate`, `ST_Rotate`, `ST_Affine` |
| [Bounding box](/docs/2.0.0-rc3/sql/spatial-functions#bounding-box) | 8 | `ST_Envelope`, `ST_XMin`, `ST_YMax` |
| [Tessellation](/docs/2.0.0-rc3/sql/spatial-functions#tessellation) | 4 | `ST_DelaunayTriangles`, `ST_VoronoiPolygons` |
| [Bearings](/docs/2.0.0-rc3/sql/spatial-functions#bearings) | 2 | `ST_Azimuth`, `ST_Project` |
| [Edits](/docs/2.0.0-rc3/sql/spatial-functions#edits) | 7 | `ST_Multi`, `ST_SnapToGrid`, `ST_Dump` |
| [Aggregate functions](/docs/2.0.0-rc3/sql/spatial-functions#aggregate-functions) | 3 | `ST_Extent`, `ST_Collect`, `ST_MemUnion` |
| [Window functions](/docs/2.0.0-rc3/sql/spatial-functions#window-functions) | 2 | `ST_ClusterKMeans`, `ST_ClusterDBSCAN` |
| [Reprojection](/docs/2.0.0-rc3/sql/spatial-functions#reprojection) | 1 | `ST_Transform` |
