...
can read. See [Access control](/docs/2.0.0-rc3/security/access-control).
...
[Function Reference](/docs/2.0.0-rc3/sql/function-reference) holds the other functions.
...
Create a crawler. This endpoint matches [`CREATE CRAWLER`](/docs/2.0.0-rc3/server/crawlers):
