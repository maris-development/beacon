...
2. **[Configure](/docs/2.0.0-rc3/server/configuration)** the ports, the datasets store and the
   resource limits.
3. **[Register your data](/docs/2.0.0-rc3/server/)** as tables and views, so clients query names
   instead of paths.
4. **[Secure and expose](/docs/2.0.0-rc3/security/access-control)** it, then point clients at it.
...
[admin web UI](/docs/2.0.0-rc3/connect/web-admin-ui). You deploy nothing extra. The UI gives you:
...
[JetBrains DataGrip](/docs/2.0.0-rc3/connect/datagrip) and the
[Python ADBC driver](/docs/2.0.0-rc3/connect/python-adbc) use it. Flight SQL authenticates with a
bearer token. Tune it or switch it off with the `BEACON_FLIGHT_SQL_*`
[settings](/docs/2.0.0-rc3/server/configuration#arrow-flight-sql).
:::
...
[access control](/docs/2.0.0-rc3/security/access-control) with `BEACON_AUTH_ENFORCE=true`.
:::
...
| | |
| - | - |
| **Every setting** | [Configuration](/docs/2.0.0-rc3/server/configuration) |
| **Put the datasets on a bucket** | [Object Storage](/docs/2.0.0-rc3/data-sources/object-storage) |
| **Memory, concurrency, caches** | [Performance Tuning](/docs/2.0.0-rc3/server/performance-tuning) |

**Register the data**

| | |
| - | - |
| **Name a set of files** | [External Tables](/docs/2.0.0-rc3/data-sources/external-tables) |
| **Save a query** | [Views](/docs/2.0.0-rc3/server/view) · [Materialized Views](/docs/2.0.0-rc3/sql/create-materialized-view) |
| **Register a large tree on a schedule** | [Crawlers](/docs/2.0.0-rc3/server/crawlers) |
| **Own the rows yourself** | [Managed Tables](/docs/2.0.0-rc3/sql/managed-tables) |
| **Reach another node or a database** | [ATTACH](/docs/2.0.0-rc3/data-sources/attach) · [SQL Databases](/docs/2.0.0-rc3/data-sources/sql-databases) |

**Expose it**

| | |
| - | - |
| **Decide who reads what** | [Access Control](/docs/2.0.0-rc3/security/access-control) |
| **Explore in the browser** | [Admin Web UI](/docs/2.0.0-rc3/connect/web-admin-ui) |
| **Point clients at it** | [Python](/docs/2.0.0-rc3/connect/python) · [TypeScript](/docs/2.0.0-rc3/connect/typescript) · [CLI](/docs/2.0.0-rc3/connect/cli) · [DataGrip](/docs/2.0.0-rc3/connect/datagrip) · [Python ADBC](/docs/2.0.0-rc3/connect/python-adbc) |
| **Document the query API** | [REST API](/docs/2.0.0-rc3/api/) |

**When something is wrong**

[Troubleshooting](/docs/2.0.0-rc3/troubleshooting) · [FAQ](/docs/2.0.0-rc3/faq)
