...
[`read_atlas()`](/docs/2.0.0-rc3/sql/table-functions#read-atlas) table function. Point at
...
[external table](/docs/2.0.0-rc3/data-sources/external-tables#atlas). Point the `LOCATION`
...
[materialized view](/docs/2.0.0-rc3/sql/create-materialized-view). This works over an Atlas
