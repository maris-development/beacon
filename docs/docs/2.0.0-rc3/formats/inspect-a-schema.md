...
[`SUMMARIZE`](/docs/2.0.0-rc3/sql/summarize) gives more than names and types. It profiles every
...
- [File formats](/docs/2.0.0-rc3/formats/) and the capability matrix
- [Arrays to tables](/docs/2.0.0-rc3/arrays-to-tables), for what a dimension does to the column list
- [SUMMARIZE](/docs/2.0.0-rc3/sql/summarize) for the full statement grammar
