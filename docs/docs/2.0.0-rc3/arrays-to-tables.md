...
- [CF decoding](/docs/2.0.0-rc3/cf-decoding): what Beacon does with `scale_factor`, `_FillValue`
  and time units
- [Coming from xarray](/docs/2.0.0-rc3/coming-from-xarray): the same operations, side by side
- [NetCDF](/docs/2.0.0-rc3/formats/netcdf) and [Zarr](/docs/2.0.0-rc3/formats/zarr) for
