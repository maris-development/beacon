...
across the 400 levels. See [Arrays to tables](/docs/2.0.0-rc3/arrays-to-tables).
...
[`SUMMARIZE`](/docs/2.0.0-rc3/sql/summarize) profiles every column in one pass. It gives the type,
...
See [UNION BY NAME](/docs/2.0.0-rc3/sql/union-by-name).
...
[Atlas](/docs/2.0.0-rc3/formats/atlas) collection. Atlas drops whole datasets
with its stored statistics. See
[Speed Up Slow Queries](/docs/2.0.0-rc3/guides/speed-up-queries).
