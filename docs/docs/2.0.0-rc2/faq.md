...
[external table](/docs/2.0.0-rc2/beacondb/data-sources/external-tables) at a path and query it. Nothing
is copied or rewritten.

### Which formats are supported?

Parquet, GeoParquet, CSV/TSV, Arrow IPC, NetCDF, Zarr, Atlas, GeoTIFF/COG, BBF, Delta Lake, and ODV
ASCII. Each has its own chapter in [File Formats](/docs/2.0.0-rc2/beacondb/data-sources/formats/).

## Reading files

### How do I see what columns and types a file has?

[`read_schema()`](/docs/2.0.0-rc2/beacondb/sql/table-functions-utility#read-schema) returns the schema
...
[`SUMMARIZE`](/docs/2.0.0-rc2/beacondb/sql/summarize) instead.
...
[`UNION BY NAME`](/docs/2.0.0-rc2/beacondb/sql/union-by-name). Missing columns become nulls instead of
misaligning.
...
[`read_delta()`](/docs/2.0.0-rc2/beacondb/data-sources/formats/delta-lake) at them directly, or register
...
[view](/docs/2.0.0-rc2/data-lake/view) if you want a stable name.
...
[Zarr](/docs/2.0.0-rc2/beacondb/data-sources/formats/zarr) or
[Atlas](/docs/2.0.0-rc2/beacondb/data-sources/formats/atlas).
...
collections into [Atlas](/docs/2.0.0-rc2/beacondb/data-sources/formats/atlas). Full detail in
...
[Beacon Data Lake](/docs/2.0.0-rc2/getting-started) and connect to it instead.
...
a [materialized view](/docs/2.0.0-rc2/beacondb/sql/create-materialized-view) is usually the better fit.
...
authenticated federation, use [`ATTACH`](/docs/2.0.0-rc2/beacondb/data-sources/attach), which accepts a
...
up. A [crawler](/docs/2.0.0-rc2/data-lake/crawlers) with a schedule is the way to pick up new files.
...
[Concepts](/docs/2.0.0-rc2/concepts) for how the pieces fit together.
