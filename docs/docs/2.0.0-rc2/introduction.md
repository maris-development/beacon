...
New here? Jump to the **[Quick Start](/docs/2.0.0-rc2/quickstart)** to get running in a couple of minutes.
...
Everything in the [SQL reference](/docs/2.0.0-rc2/beacondb/sql/) works either way. A query travels
