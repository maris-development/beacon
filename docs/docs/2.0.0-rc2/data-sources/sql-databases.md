...
[Remote tables](/docs/2.0.0-rc2/data-sources/remote-tables) use the same pushdown
mechanism.
...
- A [**remote table**](/docs/2.0.0-rc2/data-sources/remote-tables) is a federated pointer at
