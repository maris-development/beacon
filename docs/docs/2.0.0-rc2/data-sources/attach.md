...
[remote table](/docs/2.0.0-rc2/data-sources/remote-tables). Both use Arrow Flight SQL
...
[remote table](/docs/2.0.0-rc2/data-sources/remote-tables) when you need one table under a
fixed local name.
...
[Remote Tables](/docs/2.0.0-rc2/data-sources/remote-tables#how-pushdown-works) for the
...
[Python client](/docs/2.0.0-rc2/connect/python), the [CLI](/docs/2.0.0-rc2/connect/cli) or the HTTP
API. See [Remote Tables](/docs/2.0.0-rc2/sql/remote-tables) for the table-level equivalent.
