...
A view works over a [table function](/docs/2.0.0-rc2/sql/table-functions) and over an
...
[UNION ALL BY NAME](/docs/2.0.0-rc2/sql/union-by-name) for the column matching and the type
widening.
