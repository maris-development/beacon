...
`CREATE SECRET` stores a credential under a name. [`ATTACH`](/docs/2.0.0-rc2/data-sources/attach)
...
[configuration](/docs/2.0.0-rc2/server/configuration), and it takes its credentials from the
...
- [ATTACH](/docs/2.0.0-rc2/data-sources/attach): mirror a remote catalog
- [Remote Tables](/docs/2.0.0-rc2/sql/remote-tables): one remote table instead of a whole catalog
- [Access Control](/docs/2.0.0-rc2/security/access-control): who may run `CREATE SECRET`
