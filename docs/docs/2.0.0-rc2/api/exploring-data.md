...
[Function Reference](/docs/2.0.0-rc2/sql/function-reference) holds the other functions.
...
Create a crawler. This endpoint matches [`CREATE CRAWLER`](/docs/2.0.0-rc2/server/crawlers):
