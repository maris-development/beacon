...
[`read_parquet`](/docs/2.0.0-rc2/beacondb/sql/table-functions), `read_netcdf`, `read_zarr`, `read_csv`,
...
IPC, and Delta Lake. See [Supported formats](/docs/2.0.0-rc2/data-lake/datasets).
...
- **Remote tables / catalogs**: tables on *another* Beacon, reached over Flight SQL and federated
  (filters/joins/aggregates push down). See [`ATTACH`](/docs/2.0.0-rc2/beacondb/sql/remote-tables).
...
encrypted into the `beacon.db` file. See [Secrets](/docs/2.0.0-rc2/beacondb/sql/secrets).
...
see the [SQL reference](/docs/2.0.0-rc2/beacondb/sql/) and the datalake [querying guide](/docs/2.0.0-rc2/api/querying/).
...
[datalake access control](/docs/2.0.0-rc2/security/access-control).
