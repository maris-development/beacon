...
[Atlas](/docs/2.0.0-rc2/beacondb/data-sources/formats/atlas) is usually the single largest win. Atlas
...
A [materialized view](/docs/2.0.0-rc2/beacondb/sql/create-materialized-view) caches the result and is
refreshed on demand:
...
A [managed table](/docs/2.0.0-rc2/beacondb/data-sources/internal-format) is the right choice when you
