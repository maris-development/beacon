...
[Remote Tables (Federation) setup chapter](/docs/2.0.0-rc2/beacondb/data-sources/remote-tables)
...
[limitations in the setup chapter](/docs/2.0.0-rc2/beacondb/data-sources/remote-tables#limitations).
:::
...
**BeaconDB** gives the same function as `con.attach(name, url, …)`. See
