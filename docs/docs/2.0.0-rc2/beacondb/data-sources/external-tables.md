...
Then use a [managed table](/docs/2.0.0-rc2/beacondb/sql/managed-tables).
:::

:::tip Register many datasets at once
A [crawler](/docs/2.0.0-rc2/data-lake/crawlers) finds and registers many datasets under a prefix. It
...
[`CREATE EXTERNAL TABLE`](/docs/2.0.0-rc2/beacondb/sql/create-table) reference gives the full
...
[GeoParquet](/docs/2.0.0-rc2/beacondb/data-sources/formats/geoparquet) for the details.
...
the [`read_odv_ascii()`](/docs/2.0.0-rc2/beacondb/sql/table-functions#read-odv-ascii) table function.
...
[Delta Lake](/docs/2.0.0-rc2/beacondb/data-sources/formats/delta-lake) table. The `LOCATION` points
...
new Delta version. See [Delta Lake](/docs/2.0.0-rc2/beacondb/data-sources/formats/delta-lake) for the
full reference.
...
[`PARTITIONED BY`](/docs/2.0.0-rc2/beacondb/sql/create-table#partitioned-by) for the syntax.
...
[Remote Tables (Federation)](/docs/2.0.0-rc2/beacondb/data-sources/remote-tables) for the full
reference.

## Views

A view holds a persistent SQL query over any external table or table function. See the
[Views](/docs/2.0.0-rc2/data-lake/view) page for the full reference. It also covers
...
[`DROP TABLE`](/docs/2.0.0-rc2/beacondb/sql/create-table#drop-table).
