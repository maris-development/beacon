...
This is built on [`datafusion-table-providers`](https://github.com/datafusion-contrib/datafusion-table-providers) and DataFusion's federation layer, the same pushdown mechanism used by [remote tables](/docs/2.0.0-rc2/beacondb/data-sources/remote-tables).
...
- A [**remote table**](/docs/2.0.0-rc2/beacondb/data-sources/remote-tables) is a federated pointer at a table on another Beacon instance.
