...
[object storage](/docs/2.0.0-rc2/beacondb/sql/secrets) (`s3://`, `gs://`, `az://`).
...
[`read_schema()`](/docs/2.0.0-rc2/beacondb/sql/table-functions-utility#read-schema) does this **without
reading any data**:
...
[`SUMMARIZE`](/docs/2.0.0-rc2/beacondb/sql/summarize) profiles every column in a single pass:
...
Array formats such as [Zarr](/docs/2.0.0-rc2/beacondb/data-sources/formats/zarr) and [Atlas](/docs/2.0.0-rc2/beacondb/data-sources/formats/atlas) point at their marker file (`zarr.json`,
...
once as an [external table](/docs/2.0.0-rc2/beacondb/data-sources/external-tables) and query it by name:
...
- [Reading External Files](/docs/2.0.0-rc2/beacondb/data-sources/): the reading model end to end.
