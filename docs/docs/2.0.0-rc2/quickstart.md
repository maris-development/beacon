...
behind a real archive. Continue to **[Getting Started](/docs/2.0.0-rc2/getting-started)** for Docker
...
There are clients for [TypeScript](/docs/2.0.0-rc2/connect/typescript), the
[terminal](/docs/2.0.0-rc2/connect/cli), and any JDBC or ADBC tool over
[Arrow Flight SQL](/docs/2.0.0-rc2/connect/datagrip).
...
the connection. See [ATTACH](/docs/2.0.0-rc2/data-sources/attach) for authentication. See
[Remote Tables](/docs/2.0.0-rc2/sql/remote-tables) to attach one table instead of a whole
catalog.
...
| | |
|---|---|
| **Run it properly** | [Getting Started](/docs/2.0.0-rc2/getting-started) · [Configuration](/docs/2.0.0-rc2/server/configuration) |
| **Name your data** | [Server Setup](/docs/2.0.0-rc2/server/) |
| **Write queries** | [SQL Reference](/docs/2.0.0-rc2/sql/) |
| **Coming from Python** | [Coming from xarray](/docs/2.0.0-rc2/coming-from-xarray) |
