...
| --- | --- | --- | --- | --- |
| [Parquet](/docs/2.0.0-rc2/beacondb/data-sources/formats/parquet) | `.parquet` | `PARQUET` | `read_parquet` | yes |
| [GeoParquet](/docs/2.0.0-rc2/beacondb/data-sources/formats/geoparquet) | `.geoparquet` | `GEOPARQUET` | `read_geoparquet` | yes |
| [CSV / TSV](/docs/2.0.0-rc2/beacondb/data-sources/formats/csv) | `.csv`, `.tsv` | `CSV` | `read_csv` | yes |
| [Arrow IPC](/docs/2.0.0-rc2/beacondb/data-sources/formats/arrow) | `.arrow`, `.feather` | `ARROW` | `read_arrow` | yes (`ipc`) |
| [NetCDF](/docs/2.0.0-rc2/beacondb/data-sources/formats/netcdf) | `.nc` | `NC` | `read_netcdf` | yes (+ ND-NetCDF) |
| [Zarr](/docs/2.0.0-rc2/beacondb/data-sources/formats/zarr) | `zarr.json` marker | `ZARR` | `read_zarr` | no |
| [Atlas](/docs/2.0.0-rc2/beacondb/data-sources/formats/atlas) | `atlas.json` marker | `ATLAS` | `read_atlas` | no |
| [GeoTIFF / COG](/docs/2.0.0-rc2/beacondb/data-sources/formats/geotiff) | `.tif`, `.tiff` | `TIFF` | `read_tiff` | no |
| [BBF](/docs/2.0.0-rc2/beacondb/data-sources/formats/bbf) | `.bbf` | `BBF` | `read_bbf` | no |
