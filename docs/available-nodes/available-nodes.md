...
<!-- PUBLIC NODE URL: also in .vitepress/theme/components/HeroQuery.vue and docs/2.0.0-rc3/quickstart.md. -->
...
[Quick Start](/docs/2.0.0-rc3/quickstart#query-a-public-node) for the Python client.
