...
const start = withBase('/docs/1.7.0/getting-started')
</script>
...
.cta-btn.alt:hover { border-color: var(--vp-c-brand-1); color: var(--vp-c-brand-1); }

@media (max-width: 640px) {
  .cta-code { font-size: 0.74rem; word-break: break-all; }
}
</style>
