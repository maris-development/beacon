...
// already runs. Both land on 2.0.0-rc4 — that is the release this page
...
const paths = [
  {
    ...
    cta: 'Deploy a server',
    link: withBase('/docs/2.0.0-rc4/getting-started'),
  },
  {
    key: 'try',
    eyebrow: 'No setup',
    ...
    link: withBase('/docs/2.0.0-rc4/quickstart#query-the-public-node'),
  },
]
</script>
