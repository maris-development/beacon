        ...
        text: 'Docs', items: [
          {
            ...
            activeMatch: '/docs/1.6.0/introduction'
          },
        ]
      },
      {
      ...
      '/docs/1.6.0/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'Configuration',
              link: '/docs/1.6.0/data-lake/configuration',
            },
            {
              text: 'Performance Tuning',
              link: '/docs/1.6.0/data-lake/performance-tuning',
              collapsed: true,
              items: [
                {
                  text: 'Settings',
                  link: '/docs/1.6.0/data-lake/performance-tuning#beacon-query-engine-settings'
                },
                {
                  text: 'NetCDF',
                  link: '/docs/1.6.0/data-lake/performance-tuning#netcdf-tuning'
                },
                {
                  text: 'Zarr',
                  link: '/docs/1.6.0/data-lake/performance-tuning#zarr-statistics-predicate-pruning'
                }
              ]
            }
          ]
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  text: 'Examples',
                  link: '/docs/1.6.0/api/querying/examples',
                },
              ]
            },
          ]
