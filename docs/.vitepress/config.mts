        ...
        text: 'Docs', items: [
          {
            ...
            activeMatch: '/docs/1.5.4/introduction'
          },
        ]
      },
      {
      ...
      '/docs/1.5.4/': [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Local',
              link: '/docs/1.5.4/getting-started#local',
            },
            {
              text: 'Cloud (S3)',
              link: '/docs/1.5.4/getting-started#s3-compatible-object-storage',
            }
          ]
        },
        {
          text: 'Data Lake Setup',
          link: '/docs/1.5.4/data-lake',
          collapsed: false,
          items: [
            {
              text: 'Datasets',
              link: '/docs/1.5.4/data-lake/datasets',
              items: [
                {
                  text: 'Zarr',
                  link: '/docs/1.5.4/data-lake/datasets#zarr'
                },
                {
                  text: 'NetCDF',
                  link: '/docs/1.5.4/data-lake/datasets#netcdf'
                },
                {
                  text: 'ODV ASCII',
                  link: '/docs/1.5.4/data-lake/datasets#odv-ascii'
                },
                {
                  text: 'Parquet',
                  link: '/docs/1.5.4/data-lake/datasets#parquet'
                },
                {
                  text: 'CSV',
                  link: '/docs/1.5.4/data-lake/datasets#csv'
                },
                {
                  text: 'Arrow IPC',
                  link: '/docs/1.5.4/data-lake/datasets#arrow-ipc'
                },
                {
                  text: 'Beacon Binary Format',
                  link: '/docs/1.5.4/data-lake/datasets#beacon-binary-format'
                },
              ]
            },
            {
              text: 'Collections',
              link: '/docs/1.5.4/data-lake/collections',
              collapsed: true,
              items: [
                {
                  text: 'Logical Collections',
                  link: '/docs/1.5.4/data-lake/collections#logical-data-tables'
                },
                {
                  text: 'Preset Collections',
                  link: '/docs/1.5.4/data-lake/collections#preset-data-tables'
                }
              ]
            },
            {
              text: 'Configuration',
              link: '/docs/1.5.4/data-lake/configuration',
            },
            {
              text: 'Performance Tuning',
              link: '/docs/1.5.4/data-lake/performance-tuning',
              collapsed: true,
              items: [
                {
                  text: 'Settings',
                  link: '/docs/1.5.4/data-lake/performance-tuning#beacon-query-engine-settings'
                },
                {
                  text: 'NetCDF',
                  link: '/docs/1.5.4/data-lake/performance-tuning#netcdf-tuning'
                },
                {
                  text: 'Zarr',
                  link: '/docs/1.5.4/data-lake/performance-tuning#zarr-statistics-predicate-pruning'
                }
              ]
            }
          ]
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              link: '/docs/1.5.4/api/exploring-data-lake',
            },
            {
              text: 'Querying',
              link: '/docs/1.5.4/api/querying',
              collapsed: false,
              items: [
                {
                  text: 'SQL',
                  link: '/docs/1.5.4/api/querying/sql',
                },
                {
                  text: 'JSON',
                  link: '/docs/1.5.4/api/querying/json',
                  items: [
                    {
                      text: 'Selecting Columns',
                      link: '/docs/1.5.4/api/querying/json#selecting-columns'
                    },
                    {
                      text: 'From',
                      link: '/docs/1.5.4/api/querying/json#choosing-the-data-source-from'
                    },
                    {
                      text: 'Filtering',
                      link: '/docs/1.5.4/api/querying/json#filters'
                    },
                    {
                      text: 'Output',
                      link: '/docs/1.5.4/api/querying/json#output-formats'
                    }
                  ]
                },
                {
                  text: 'Examples',
                  link: '/docs/1.5.4/api/querying/examples',
                },
              ]
            },
          ]
        ...
        },
        {
          ...
          link: '/docs/1.5.4/libraries-tooling',
          items: [
            {
              text: 'Python',
              link: '/docs/1.5.4/libraries-tooling/python-sdk',
            },
            {
              text: 'CLI Tool',
              link: '/docs/1.5.4/libraries-tooling/cli',
            }
          ]
        }
      ],
