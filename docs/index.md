...
features:
  ...
  - title: One SQL, everywhere
    ...
    details: The exact same SQL dialect and formats in both products. Create external and managed tables, views and secrets, and ATTACH remote Beacons, whether embedded or served.
