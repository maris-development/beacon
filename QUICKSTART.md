...
- [Quick Start](https://maris-development.github.io/beacon/docs/2.0.0-rc4/quickstart) — the same steps, with a public server to try.
- [Documentation](https://maris-development.github.io/beacon/) — full data model and API reference.
- [Configuration reference](https://maris-development.github.io/beacon/docs/2.0.0-rc4/server/configuration.html) — all `BEACON_*` settings.
