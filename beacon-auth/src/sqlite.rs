...
/// Authentication provider backed by a [`SqliteStore`]. Expects credentials as `"username:password"`.
#[derive(Debug, Clone)]
...
fn decode_target(target_type: &str, target_value: String) -> anyhow::Result<Option<PrivilegeTarget>> {
