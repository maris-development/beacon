...
//!
//! These operations are how files get into and out of the server. File mutation is
...
//!   is deliberately not restricted: a server holds whatever the operator puts
