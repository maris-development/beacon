...
own [RBAC](/docs/2.0.0-rc5/security/access-control) to your identity. Local file access has no such
boundary. This connection *does* have one.

You can also store the credentials as a [secret](/docs/2.0.0-rc5/beacondb/python/secrets). Then
...
See the shared [`ATTACH` reference](/docs/2.0.0-rc5/beacondb/sql/remote-tables).
