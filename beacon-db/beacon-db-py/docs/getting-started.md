...
[platform support](/docs/2.0.0-rc6/beacondb/python/#platform-support).
...
Pass `auth=True` to switch on the [RBAC](/docs/2.0.0-rc6/security/access-control) of Beacon. A
...
- [Querying](/docs/2.0.0-rc6/beacondb/python/querying): the lazy relation, the readers and the file sinks.
- [Bring data in](/docs/2.0.0-rc6/beacondb/python/data-in): `register()` and `append()`.
- The full [SQL reference](/docs/2.0.0-rc6/beacondb/sql/) applies without a change.
