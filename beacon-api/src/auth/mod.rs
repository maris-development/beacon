...
//!
//! This module is intentionally transport-neutral so credential parsing and
//! validation stay consistent no matter which server surface receives the request.
