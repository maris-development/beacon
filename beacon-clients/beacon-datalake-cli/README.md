...
A terminal client for a [Beacon](../../) server. Run SQL against a running
...
```bash
pip install -e "beacon-clients/beacon-datalake-cli[dev]"
ruff check beacon-clients/beacon-datalake-cli
pytest beacon-clients/beacon-datalake-cli
```
