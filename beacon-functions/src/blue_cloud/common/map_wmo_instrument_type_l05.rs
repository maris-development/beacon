...
const L05_MAPPINGS_CSV: &[u8] = include_bytes!("wmo_instrument_type_l05.csv");
...
pub fn map_wmo_instrument_type_l05() -> ScalarUDF {
    create_udf(
        "map_wmo_instrument_type_l05",
        vec![datafusion::arrow::datatypes::DataType::Utf8],
        datafusion::arrow::datatypes::DataType::Utf8,
        datafusion::logical_expr::Volatility::Immutable,
        Arc::new(map_wmo_instrument_type_l05_impl),
    )
}

fn map_wmo_instrument_type_l05_impl(
...
mod tests {
    ...
    #[test]
    fn test_loading_l05_mappings() {
        let mappings = L05_MAP.clone();
