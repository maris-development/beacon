...
const L22_MAPPINGS_CSV: &[u8] = include_bytes!("wmo_instrument_type_l22.csv");
...
pub fn map_wmo_instrument_type_l22() -> ScalarUDF {
    create_udf(
        "map_wmo_instrument_type_l22",
        vec![datafusion::arrow::datatypes::DataType::Utf8],
        datafusion::arrow::datatypes::DataType::Utf8,
        datafusion::logical_expr::Volatility::Immutable,
        Arc::new(map_wmo_instrument_type_l22_impl),
    )
}

fn map_wmo_instrument_type_l22_impl(
