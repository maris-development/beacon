...
impl Runtime {
    ...
    fn init_ctx(
        ...
        config.options_mut().optimizer.expand_views_at_output = true; // Expand VIEW types like utf8view to their underlying types (e.g. utf8) in the output schema, so clients don't see the view type and fail to decode it.
